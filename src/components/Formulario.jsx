...
const Formulario = ({pacientes,setPacientes,paciente,setPaciente}) => {
  ...
  const handleSubmit=(e)=>{
    e.preventDefault();
    //validar un el formulario
    if([nombre,propietario,email,fecha,sintomas].includes("")){
      console.log("hay la menos un campo vacío")
      setError(true)
      return;
    }
    setError(false)
    ...
    if(paciente.id){
      ...
      const pacientesActualizados=pacientes.map(pacienteState=>pacienteState.ide===paciente.id? objetoPaciente:pacienteState)
      setPacientes(pacientesActualizados)
      setPaciente({})
      //eEditando el registro
    }else{
      //Nuevo registro
